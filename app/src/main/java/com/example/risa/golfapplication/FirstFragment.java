...
public class FirstFragment extends Fragment {
    ...
    public void createExampleList() {
        mPlaces = new ArrayList<>();
        mPlaces.add(new Place(R.drawable.image1, "The Complete Golf Course for Beginners","JrF2qVeQmxk"));
        mPlaces.add(new Place(R.drawable.image02, "Golf Course: Advanced Concepts","JrF2qVeQmxk"));
        mPlaces.add(new Place(R.drawable.image3, "Learning Professional Golf Player","JrF2qVeQmxk"));
    }
